...
<div id="smlCartClearDiv">
	...
	<iframe id="smlIframeBase" class="smlCartIframe" src="<?php echo $smlBaseUrl.$smlCartUrl ?>" frameborder="0" scrolling="scroll" seamless="seamless" marginheight="0" marginwidth="0"></iframe>
